...
* @version $Id: bidder.php,v 1.1 2005/06/15 07:57:47 nicolasconnault Exp $
* @copyright 2005
*/
...
$bidder = $auction->getUserObject($userID);

$category = new category(array("ID" => $get['categoryID']));
$item = $auction->getItem($get['itemID']);

$bidder->getID(); //Added the user's ID to the user object
...
$smarty->display("auction_bidder.tpl");
