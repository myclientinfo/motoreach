...
$main_content = new Template('user_matches');
//$sidebar = new Template('user_sidebar');
//$sidebar->set('recent_bids', $auction->getRecentBids($user->ID));
...
if (isset($_SESSION['authorised'])) {
	...
	header('location: /login.php?loc='.base64_encode($_SERVER['SCRIPT_NAME']));
}
...
$main_content->set('user_matches', Auction::getUserMatches());
