...
$main_content = new Template('user_index');

$listing = new Template('listing');


$listing->set('content', Auction::getUserItems($user['ID']));
$main_content->set('vehicles_listed', $listing->fetch());

$listing->set('content', User::getBidVehicles());
$main_content->set('bids_made', $listing->fetch());
