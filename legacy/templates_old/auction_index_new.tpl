{* Smarty *}
{include file="auction_header_new.tpl" title="$COMPANY_NAME :: Silent Auction -- Home"}

<div id="container">
{include file="auction_menu_new.tpl"}
...
<div id="rightstatic">
	...
	<div id="pagebody">
		...
		<div id="leftstatic">
			{include file="auction_sidebar_new.tpl"}
			<div id="contents">
				<span id="loggedin" >		
					{if $authorised == "valid"}
...
{include file="auction_footer_new.tpl"}
